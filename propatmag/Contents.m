...
%   egm_read_data - Read a EGM data file (egm_96, egm_10) - initialize EGM
%   egm_acc       - Compute the local gravity in terrestrial coordinates
%   egm_difeq     - Orbit differential equation for numerical integration
%   
% Sunsynchronous orbit
%   sunsync_inc   - Obtains the sunsynchronous orbit inclination
%   sunsync_raan  - Obtains the right ascension of the equator crossing
%                   hour
%   sunsync_sma   - Obtains the orbit semi-major axis from the required 
%                   recovering factor
%
...
%   gg_torque     - Gravity gradient torque (normal input)
%   gravity_torque  - Gravity gradient torque (alternate input)
%
% Demo programs
...
%                   Povray
%   demo_egm      - Example of using the numeric orbit integrator
%
...
% Ver: 1.0.6
%               Sunsynchronous orbit functions (May/2017)
%               EGM - Numeric orbit integrator (July/2017)
%
