...
% GNSS
GNSS_pos_error = 0.02*0;              % position estimator error [m]
GNSS_vel_error = 1e-3*0;              % velocity estimator error [m/s]
...
switch control_strategy
    ...
    ROE_alpha_gain_horizon = 0.4;  % 0.75
    horizon_weight         = 0.0; % 0.025
    ROE_alphadot_gain      = ROE_alpha_gain * 5;
end
...
tstep_orbit    = orbit_control_tau*3;   % time step [s]
