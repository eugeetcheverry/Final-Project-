...
max_thrust  = 2.5E-4;                 % Maximum control output [N]
...
% Orbit control
ROE_alpha_gain           = 5*0.5*max_thrust/0.00005*1000000/50/5.5; % 0 cont�nuo, 1 pulsado

if continuous == 1
  ROE_alpha_gain         = 100*0.5*max_thrust/0.00005*1000000/50/5.5; % 0 cont�nuo, 1 pulsado
end;

iROE_alpha_gain           = 0;
dROE_alpha_gain           = 5*ROE_alpha_gain;
...
minimum_thrust_time    = orbit_period/2*0.8;
...
tend_orbit     = 24*3600*5;         % end time [s]
